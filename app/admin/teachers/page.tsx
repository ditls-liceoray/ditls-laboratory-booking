...
export default function ViewTeachersPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${supabaseUrl}/functions/v1/delete-teacher`,
        {
          method: 'POST',
          headers: {
      ...
      await logActivity(
        'delete_teacher',
        `Deleted teacher ${fullName(deleteTarget)}`
      );
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="View Teachers"
        description="Manage all teacher accounts"
      >
        <Button
                    ...
                    <TableRow className="bg-muted/50">
                      <TableHead>
                        <button
                          ...
                          onClick={() =>
                            toggleSort('teacher_id')
                          }
                          aria-label="Sort by Teacher ID"
                        >
                          Teacher ID
                      ...
                      <TableRow key={t.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center justify-end gap-1">
                            {/* FIX: Added "group" so group-hover:block works */}
                            <div className="relative group">
                              <button
                                ...
                                aria-label={`Actions for ${fullName(t)}`}
                              >
                              ...
                              <div className="absolute right-0 top-full mt-1 z-10 hidden group-hover:block">
                                <div className="bg-white dark:bg-gray-800 rounded-md shadow-lg border py-1 min-w-[120px]">
                                  <Link
                                    ...
                                    className="block px-3 py-2 text-sm text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20"
                                  >
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to delete ${deleteTarget ? fullName(deleteTarget) : ''
          }? This action cannot be undone and will remove their account.`}
