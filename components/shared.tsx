...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-background rounded-lg p-6 max-w-sm w-full mx-4 animate-scale-in"
      ...
      >
        ...
        <div className="flex gap-2 justify-end">
          <button
            onClick={onCancel}
            className="px-4 h-9 rounded-md border bg-background hover:bg-accent text-sm font-medium transition-colors"
          >
            Cancel
          </button>
...
export function ActionConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-background rounded-lg p-6 max-w-md w-full mx-4 animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
        <h3 className="text-lg font-semibold mb-2">
          {title}
...
export function ContentDetailsModal({
  ...
  return (
    ...
    >
      <div
        className="bg-background rounded-lg max-w-2xl w-full mx-4 max-h-[90vh] animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
